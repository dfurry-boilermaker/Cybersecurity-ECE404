    ...
    for i in range(15):
        ...
        if sys.argv[1] == str('-e'):
            if i == 0:
                ...
                final = curr_block
                if i == 14:
                    #convert bitvector into hex values and write to the 4th argument
            ...
            if i == 0:
                ...
                curr_block = decrypt(post_round, round_keys, i)
            elif i < 15:
                curr_block = decrypt(curr_block, round_keys, i)
                final = curr_block
                if i == 14:
                    #convert bitvector into ascii values and write to the 4th argument   
                    pt_decrypted = final.get_bitvector_in_ascii()
                    FINAL = open(sys.argv[4], 'w')
                    FINAL.write(pt_decrypted)
